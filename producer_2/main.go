...
func main() {
	...
	for {
		...
		gocv.Resize(frame, &resultImage, image.Pt(resultImage.Rows(), resultImage.Cols()), 0, 0, gocv.InterpolationLinear)
		...
		fmt.Fprintf(outputWriter, "Sending Camera 2 Bytes ---->>>> %v\n", time.Now())
	}
}
